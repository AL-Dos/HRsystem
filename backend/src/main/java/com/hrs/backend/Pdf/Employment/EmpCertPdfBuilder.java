...
public class EmpCertPdfBuilder {
    ...
    private final TableBuilder tb = new TableBuilder();

    public byte[] build(PersonalInfo info, DateFormatService dateService, List<EmploymentRow> rows) throws Exception {
